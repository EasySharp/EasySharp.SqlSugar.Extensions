...
namespace SqlSugar.Extensions
{
    public static class SugarQueryableExtensions
    {
        ...
        public static async Task<T?> InSingleAsync<T>(this ISugarQueryable<T> queryable, object pkValue) where T : class, new()
        {
        ...
        public static async Task<List<T>?> ToListAsync<T>(this ISugarQueryable<T> queryable) where T : class, new()
        {
        ...
        private static ISugarQueryable<T> CopyQueryable<T>(ISugarQueryable<T> queryable) where T : class, new()
        {
        ...
        public static async Task<T?> FirstAsync<T>(this ISugarQueryable<T> queryable, Expression<Func<T, bool>> expression) where T : class, new()
        {
            return await queryable.Where(expression).FirstAsync();
        }

        public static async Task<T?> FirstAsync<T>(this ISugarQueryable<T> queryable) where T : class, new()
        {
        ...
        public static async Task<T?> SingleAsync<T>(this ISugarQueryable<T> queryable, Expression<Func<T, bool>> expression) where T : class, new()
        {
            return await queryable.Where(expression).SingleAsync();
        }

        public static async Task<T?> SingleAsync<T>(this ISugarQueryable<T> queryable) where T : class, new()
        {
            if (queryable.SqlBuilder.QueryBuilder.OrderByValue.IsNullOrEmpty())
                queryable.SqlBuilder.QueryBuilder.OrderByValue = queryable.SqlBuilder.QueryBuilder.DefaultOrderByTemplate;
